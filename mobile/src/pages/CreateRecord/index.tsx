...
const BASE_URL = 'https://projeto-sds.herokuapp.com';
...
const createRecord = () => {
	...
	const hadleChangePlatform = (selectedPlatform: GamePlatform) => {
	...
	useEffect(() => {
		...
		.catch(() => Alert.alert('Erro ao salvar os jogos!'))
	}, []);
